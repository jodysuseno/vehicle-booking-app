      ...
      <div class="tile">
        <div class="tile-body">
          <div class="form-group">
            ...
            <input class="form-control @error('plate_number') is-invalid @enderror" value="{{ old('plate_number') }}" name="plate_number" type="text">
            @error('plate_number')
          ...
          <div class="form-group">
            ...
            <select class="form-control @error('type') is-invalid @enderror" value="{{ old('type') }}" name="type" id="exampleSelect1">
          ...
          <div class="form-group">
            ...
            <select class="form-control @error('ownership') is-invalid @enderror" value="{{ old('ownership') }}" name="ownership" id="exampleSelect1">
          ...
          <div class="form-group">
            ...
            <input class="form-control @error('years') is-invalid @enderror" value="{{ old('years') }}" name="years" type="number">
            @error('years')
            <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          </div>
