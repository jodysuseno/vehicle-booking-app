      ...
      <div class="tile">
        <div class="tile-body">
          <div class="form-group">
            ...
            <input class="form-control @error('id_card') is-invalid @enderror" value="{{ old('id_card') }}" name="id_card" type="text">
            @error('id_card')
          ...
          <div class="form-group">
            ...
            <input class="form-control @error('phone') is-invalid @enderror" value="{{ old('phone') }}" name="phone" type="text">
            @error('phone')
            <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          </div>
          <div class="form-group">
            ...
            <input class="form-control @error('address') is-invalid @enderror" value="{{ old('address') }}" name="address" type="text">
            @error('address')
            <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          </div>
